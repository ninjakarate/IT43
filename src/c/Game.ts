import { Doors, Tiles, PlayerType } from "../utils/types"
...
export default class Game {
    ...
    checkMap = (m: number[][], x: number, y: number) => {
        ...
        // Заполнение предыдущей строки
        this.checkMap(m, x - 1, y);
        // Заполнение следующей строки
        this.checkMap(m, x + 1, y);
        // Заполнение предыдущей колонки
        this.checkMap(m, x, y - 1);
        // Заполнение следующей колонки
        this.checkMap(m, x, y + 1);
    }
